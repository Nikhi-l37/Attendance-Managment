        ...
        <form onSubmit={handleSubmit}>
         ...
         <div className="mt-6 text-center text-sm text-slate-500">
             <p>
                ...
                <button onClick={toggleFormMode} className="font-medium text-indigo-600 hover:text-indigo-500">
         ...
         <div className="mt-6 text-center text-sm text-slate-500 border-t pt-4">
            ...
            <p>1. First-time admin? Use 'Sign Up'.</p>
            <p>2. Students & Teachers must be added by an admin before they can sign in.</p>
        </div>
      </div>
    </div>
  );
